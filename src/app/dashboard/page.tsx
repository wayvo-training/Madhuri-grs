  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-emerald-200/80 bg-emerald-50/50 p-6 shadow-xs">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs text-center py-12">
          ...
          <h3 className="text-base font-bold text-slate-900">
            End User Grievance Portal
          </h3>
          <p className="mx-auto mt-1 max-w-md text-xs text-slate-500">
            This dashboard is dedicated to the End User role. Multi-step
            grievance filing, dynamic category selection, evidence attachments,
            and reopen requests will be implemented in the End User phase.
          </p>
          <div className="mt-4 inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-medium text-slate-600">
            ...
            <span>
              Role-Based Route Guard Active &bull; END_USER Access Only
            </span>
          </div>
        </div>
      </div>
