            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1 text-sm font-semibold text-emerald-700 hover:text-[#064E3B]"
                >
              ...
              <div className="mt-5 space-y-4">
                {departments.length === 0 ? (
                  <p className="py-6 text-center text-sm font-normal text-slate-400">
              ...
              <div className="mt-4 overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead className="border-b border-slate-100 bg-slate-50/60 text-xs font-semibold uppercase tracking-wider text-slate-500">
                    <tr>
                      <th className="py-3 pl-3 pr-2">Ticket</th>
                      <th className="px-3 py-3">Category</th>
                      <th className="px-3 py-3">Department</th>
                      <th className="px-3 py-3">Priority</th>
                      <th className="py-3 pl-2 pr-3 text-right">Status</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 font-normal text-slate-700">
                    {recentGrievances.length === 0 ? (
                      <tr>
                        <td
                          colSpan={5}
                          className="py-6 text-center text-sm font-normal text-slate-400"
                        >
                      ...
                      recentGrievances.map((g) => (
                        ...
                        >
                          <td className="whitespace-nowrap py-3.5 pl-3 pr-2 font-mono font-medium text-slate-900 text-sm">
                            {g.grievance_number}
                          </td>
                          <td className="whitespace-nowrap px-3 py-3.5 font-normal text-slate-800 text-sm">
                            {g.categories.category_name}
                          </td>
                          <td className="whitespace-nowrap px-3 py-3.5 font-normal text-slate-600 text-sm">
                            {g.grievance_departments?.departments
                              ?.department_name || (
                              <span className="italic text-amber-600 text-xs font-normal">
                                Unrouted
                              </span>
                            )}
                          </td>
                          ...
                          <td className="whitespace-nowrap py-3.5 pl-2 pr-3 text-right">
          ...
          <div className="space-y-6">
            ...
            {routingExceptionsCount > 0 ? (
              <div className="rounded-2xl border border-amber-200 bg-amber-50/80 p-5 text-amber-900 shadow-xs">
                <div className="flex items-center gap-2 font-semibold text-base text-amber-900">
                  <AlertTriangle className="h-5 w-5 text-amber-600 shrink-0" />
                  <h4>Manual Routing Required</h4>
                </div>
                <p className="mt-2 text-sm font-normal text-amber-700 leading-relaxed">
                ...
                <Link
                  href="/admin/grievances"
                  className="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-amber-600 px-4 py-2 text-sm font-semibold text-white shadow-xs hover:bg-amber-700 transition"
                >
              ...
              <div className="rounded-2xl border border-emerald-200 bg-emerald-50/60 p-5 text-emerald-900 shadow-xs">
                <div className="flex items-center gap-2 font-semibold text-base text-emerald-900">
                  <ShieldCheck className="h-5 w-5 text-emerald-600 shrink-0" />
                  <h4>Routing Health: Optimal</h4>
                </div>
                <p className="mt-2 text-sm font-normal text-emerald-700 leading-relaxed">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs">
              ...
              <div className="mt-4 space-y-2.5">
                <Link
                  href="/admin/rules"
                  className="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50/70 p-3.5 transition hover:border-emerald-200 hover:bg-emerald-50/40"
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-100 text-[#064E3B]">
                  ...
                  <span className="rounded-md bg-white px-2.5 py-1 text-xs font-semibold text-slate-700 shadow-2xs">
