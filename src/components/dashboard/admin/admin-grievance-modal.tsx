...
import type { SerializedGrievance } from "./admin-grievance-table";

interface AdminGrievanceModalProps {
  ...
  onRouteSuccess: (
    ...
    assignedDept:
      ...
      | undefined,
    assignedSupporting: { department_id: string; department_name: string }[],
  ) => void;
}
