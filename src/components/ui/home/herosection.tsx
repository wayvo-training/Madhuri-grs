      ...
      <div className="mx-auto max-w-[1400px] px-10 pb-12 pt-14">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mt-7 flex justify-center">
            <Link
              href={ctaHref}
              className="group inline-flex items-center rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 transition-all duration-200 hover:-translate-y-0.5 hover:bg-blue-700"
            >
              {ctaText}
        ...
        <div className="relative mx-auto mt-11 max-w-6xl">
          {/* Blue backdrop */}
          <div className="absolute inset-x-6 top-8 h-[425px] rounded-[38px] bg-blue-600" />
            ...
            <div className="grid min-h-[385px] grid-cols-[190px_1fr]">
              ...
              <main className="bg-white p-7">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-xs font-semibold text-white"
                  >
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="rounded-full bg-blue-50 px-2.5 py-1 text-[10px] font-semibold text-black">
                          In Progress
                        </span>
                      </div>
